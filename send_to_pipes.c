...
/*   Updated: 2023/12/01 17:52:06 by lmedrano         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char *is_input_redir(t_commande *cmd)
{
    t_commande  *curr_cmd;
    t_args      *curr_arg;
...
char *is_output_redir(t_commande *cmd)
{
    t_commande  *curr_cmd;
    t_args      *curr_arg;
